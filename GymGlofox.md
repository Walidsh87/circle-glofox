...
| **Migrations** | 008–037 ✅ in repo. 023–027 applied to prod ✅. ⚠️ **Pending in Supabase: `028`–`037`** (028 TV; 029 WOD scaling; 030 retention outreach; 031 class waitlist; 032 Committed Club; 033 membership freeze + cron-fn frozen-skip; 034 member safety/medical cols; 035 membership_plans catalog + plan_id; 036 trial cols; 037 member_tags). |
| **Next session priority** | Run migrations 028–037 in Supabase. ⚙️ set `ANTHROPIC_API_KEY` in Vercel for #16. **Tier 3 complete; Tier 4 in progress (#27+#28+#29+#31+#32+#33+#34 done — 7/10).** Continue Tier 4 (#35 booking policies · #36 belt progression · #30 family) or #15 (programming marketplace). |
