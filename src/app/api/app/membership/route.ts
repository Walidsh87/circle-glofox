...
// 'buy' (+ the online-purchasable plan catalog), 'pay_now' (finish an unpaid buy), or null
// (front-desk-only: paid manual payer / on auto-pay / trial / frozen / end-dated / no price).
