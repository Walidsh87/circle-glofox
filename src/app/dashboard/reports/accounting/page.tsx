...
import { buildAccountingExport, type InvoiceRecord } from '@/lib/accounting-export'
    ...
    >
      <div className="max-w-5xl">
        <p className="mb-4 text-sm text-ink-2">
          Issued invoices with VAT split — importable into Zoho Books, Xero, or QuickBooks.
        </p>
        ...
        {totals.count === 0 ? (
          <p className="text-sm text-ink-2">No invoices issued in this period.</p>
        ) : (
          <>
            ...
            {hasMore && (
              <p className="mb-2 text-xs text-ink-3">
                Showing first {PREVIEW_LIMIT} rows. CSV contains all {totals.count}.
              </p>
            )}
