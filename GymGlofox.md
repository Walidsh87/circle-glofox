...
| **Migrations** | 008–035 ✅ in repo. 023–027 applied to prod ✅. ⚠️ **Pending in Supabase: `028`–`035`** (028 TV; 029 WOD scaling; 030 retention outreach; 031 class waitlist; 032 Committed Club; 033 membership freeze + cron-fn frozen-skip; 034 member safety/medical cols; 035 membership_plans catalog + plan_id). |
| **Next session priority** | Run migrations 028–035 in Supabase. ⚙️ set `ANTHROPIC_API_KEY` in Vercel for #16. **Tier 3 complete; Tier 4 in progress (#27+#28+#29+#34 done — 4/10).** Continue Tier 4 (#33 tags · #35 booking policies · #36 belt progression · #30 family · #31 prorations · #32 trials) or #15 (programming marketplace). |
