...
| **Migrations** | 008–039 ✅ in repo. 023–027 applied to prod ✅. ⚠️ **Pending in Supabase: `028`–`039`** (028 TV; 029 WOD scaling; 030 retention outreach; 031 class waitlist; 032 Committed Club; 033 membership freeze + cron-fn frozen-skip; 034 member safety/medical cols; 035 membership_plans catalog + plan_id; 036 trial cols; 037 member_tags; 038 households + profiles.household_id; 039 booking-policy cols on boxes). |
| **Next session priority** | Run migrations 028–039 in Supabase. ⚙️ set `ANTHROPIC_API_KEY` in Vercel for #16. **Tier 3 complete; Tier 4 nearly done (#27+#28+#29+#30+#31+#32+#33+#34+#35 done — 9/10).** **Last item: #36 belt/level progression** (the Tier 4 athlete-facing wedge). Or #15 (programming marketplace). |
