...
| **v2 Tier 2–13 (~95 items)** | 5 ✅ (#11 WOD programming + batch import, **#12 auto-PR detection — lift PRs + WOD/benchmark PRs (complete)**, #13 coach prep view, #23 1RM charts, #25 activity feed) · #21 mobile API ⬜ (deferred) · rest ⬜ |
| **Migrations** | 008–027 ✅ in repo (… 025 lift is_pr · 026 coach notes · 027 wod is_pr). 023 + 024 applied to prod ✅. ⚠️ **Run 025 + 026 + 027 in Supabase before those features go live** (025: lift-PR `is_pr`; 026: `athlete_coach_notes`; 027: WOD-PR `is_pr` on `workout_scores`). |
| **Next session priority** | Run migrations 025 + 026 + 027 in Supabase, then build **#14 whiteboard/TV mode** (queued — the second of the "12 and 14" pair). Other candidates: #16 AI parser (feeds batch-import pipeline). |
