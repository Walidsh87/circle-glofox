...
| **Next session priority** | Run migrations 028–036 in Supabase. ⚙️ set `ANTHROPIC_API_KEY` in Vercel for #16. **Tier 3 complete; Tier 4 in progress (#27+#28+#29+#31+#32+#34 done — 6/10).** Continue Tier 4 (#33 tags · #35 booking policies · #36 belt progression · #30 family) or #15 (programming marketplace). |
