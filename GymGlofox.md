...
| **v2 Tier 2–13 (~95 items)** | 9 ✅ (Tier 2: #11 WOD programming + batch import, #12 auto-PR, #13 coach prep, #14 whiteboard/TV, #16 AI parser, #17 scaling variations · Tier 3: **#18 at-risk scoring**, #23 1RM charts, #25 feed) · #21 mobile API ⬜ (deferred) · rest ⬜. **Tier 2 done bar #15 (deferred). Tier 3 started.** |
...
| **Next session priority** | Run migrations 028 + 029 + 030 in Supabase. ⚙️ set `ANTHROPIC_API_KEY` in Vercel for #16. Continue Tier 3 (#19 KPI dashboard, #20 gamification, #24 in-app timer, #26 waitlist) or Tier 4 (Membership depth). |
