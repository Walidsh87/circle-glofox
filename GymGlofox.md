...
10. 🚧 `[Wedge][GCC]` **Multi-PSP support beyond Stripe** — PR-1 ✅ done (port + Stripe adapter, columns renamed provider-agnostic). PR-2 📋 Packages + Tabby planned. PR-3 ⬜ pilot a real gym.
