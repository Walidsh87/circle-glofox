...
| **Migrations** | 008–038 ✅ in repo. 023–027 applied to prod ✅. ⚠️ **Pending in Supabase: `028`–`038`** (028 TV; 029 WOD scaling; 030 retention outreach; 031 class waitlist; 032 Committed Club; 033 membership freeze + cron-fn frozen-skip; 034 member safety/medical cols; 035 membership_plans catalog + plan_id; 036 trial cols; 037 member_tags; 038 households + profiles.household_id). |
| **Next session priority** | Run migrations 028–038 in Supabase. ⚙️ set `ANTHROPIC_API_KEY` in Vercel for #16. **Tier 3 complete; Tier 4 in progress (#27+#28+#29+#30+#31+#32+#33+#34 done — 8/10).** **2 left: #35 booking policies · #36 belt progression.** Or #15 (programming marketplace). |
