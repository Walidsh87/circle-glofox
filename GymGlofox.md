...
| **v2 Tier 2–13 (~95 items)** | 4 ✅ (#11 WOD programming + batch import, #12 auto-PR detection — lift PRs, #23 1RM charts, #25 activity feed) · #21 mobile API ⬜ (deferred) · rest ⬜ |
| **Migrations** | 008–025 ✅ in repo (019 RLS hardening · 020–022 packages · 023 credit fns · 024 workout_templates · 025 lift is_pr). 023 + 024 applied to prod ✅. ⚠️ **Run 025 in Supabase before auto-PR goes live** (saveLift writes `is_pr`, feed reads it). |
| **Next session priority** | Run migration 025 in Supabase, then resume v2 Tier 2 (next wedge candidates: #13 coach prep view, #16 AI parser — feeds the batch-import preview→commit pipeline; #12 WOD/benchmark PRs as a follow-on to lift PRs) |
